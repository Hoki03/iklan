        ...
        <div class="flex items-center justify-center p-20 sm:p-12 md:w-1/2 ">
          <div class="w-full">
            <form action="{{route('login_proses')}}" method="post">
              ...
              <button type="submit" class="btn-signin block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" style="">
                Sign in
              </button>
